...
gem 'turbolinks', :github => 'rails/turbolinks'           # Turbolinks makes following links in your web application faster. Read more: https://github.com/rails/turbolinks
...
gem 'inherited_resources'                                 # It makes your controllers more powerful and cleaner at the same time.
